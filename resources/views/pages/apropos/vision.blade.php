...
<div class="container px-14">
     ...
     <div class="row">
          <h2 class="text-2xl text-start mb-20 mt-20 lg:text-2xl xl:text-2xl font-bold leading-none">
               Notre vision
          </h2>
          <div class="rounded overflow-hidden flex flex-col sm:flex-col md:flex-row lg:flex-row gap-12">
               <div class="flexinitial">
                    <p class="text-justify">
                         L'Alliance- les Citoyens d'Afrique de son acronyme ACDAF est une organisation à but non
                         lucratif,
                         fondée au Sénégal le
                         29 mai 2022 à l'université Cheikh Anta Diop de Dakar conformément au code des obligations
                         civiles et
                         commerciales.<br>

                         Nous travaillons sur un projet de société embitionnant à défendre les intérêts matériels et
                         moraux
                         du continent
                         ...
                         Nos réalisations sont fécondes et probantes. Aujourd'hui, nous aspirons élargir le programme
                         partout
                         au Sénégal et dans
               ...
               <div class="flex-initial max-w-fit">
                    <img src="{{asset('assets/img/vision.jpeg')}}" alt="Mission"
                         class=" max-w-lg max-h-sm rounded-md">
               </div>
          </div>
     </div>
     <div class="row">
          ...
          <div class="rounded overflow-hidden flex flex-col sm:flex-col md:flex-row lg:flex-row gap-12">
               <div class="flex-initial max-w-fit">
                    <img src="{{asset('assets/img/valeur.jpeg')}}" alt="Mission" class=" max-w-lg max-h-sm rounded-md">
               </div>
               <div class="flexinitial">
                    <p class="text-justify">

                         Notre siège social se situe à Thiès/ Nguinth boulevard et peut être transféré à tout autre lieu
                         du
                         territoire national.

                         Le fonctionnement de notre organisation est assurée par une équipe dynamique composée d'hommes
                         et de
                         femmes dévoués
                         répartis dans le pays, dans la sous région africaine et au niveau international. <br>

                         L' ACDAF est composée d'un comité directeur, d'un bureau exécutif, de commissaires aux comptes
                         et de
                         commissions
                         techniques. <br>
